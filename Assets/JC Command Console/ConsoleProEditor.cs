...
namespace JetCreative.CommandConsolePro
{
    ...
    public class ConsoleProEditor : EditorWindow
    {
        ...
        private void DrawGenerateCacheSection()
        {
            ...
            {
                int commandCount = JCCommandConsolePro.GenerateCommandCache(
        ...
        private void DrawInputActionSection()
        {
            ...
            {
                var consoleUI = FindObjectOfType<JCConsoleProUI>();
                if (consoleUI != null)
                {
                ...
                {
                    EditorUtility.DisplayDialog(
                        "Console UI Not Found",
                        "No JCConsoleProUI component found in the current scene. " +
                        "Make sure you have added the console UI to your scene.",
                        "OK"
                    );
                }
            }
